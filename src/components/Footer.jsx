  ...
  return (
    <div data-aos="zoom-in" className="mb-3">
        ...
        <div className="mt-21 ml-33">
            <div className="container">
                <div className="grid md:grid-cols-3 pv-44 pt-5 -mt-21">
                    ...
                    <div className="py-8 px-4 2xl:ml-0 xl:ml-0 lg:ml-0 md:-ml-30 sm:ml-43 ml-2">
                    ...
                    <div className="py-8 px-4 -ml-3 2xl:ml-21 xl:ml-9 lg:ml-6 md:-ml-6 sm:ml-36">
                        <h1 className="">
                            Redes Sociales
                        </h1>
        ...
        <div className="container" >
            ...
            h-30 w-95 text-black mt-43 ml-3
            2xl:mt-29 xl:mt-29 lg:mt-29 md:mt-29 sm:mt-46 2xl:w-160
            2xl:ml-100 xl:ml-103 lg:ml-76 md:ml-44 sm:ml-30
            2xl:h-40 xl:h-40 lg:h-40 md:h-40 sm:h-40">
                <p className="text-xs text-center -mt-39 -ml-3">
