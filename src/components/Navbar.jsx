...
const Navbar = () => {
  ...
  return (
    <div className="px-0 sticky md:static top-0 z-50 bg-white">
      ...
      dark:bg-[url('/assets/fondo.prod.webp')]  bg-center flex mx-auto w-full flex-col p-6 h-43 shadow-lg 2xl:h-80
        ...
        <div className="ml-auto">
          ...
          >
            <img
              ...
              w-65 2xl:w-130 xl:w-70 lg:w-60 md:w-50 sm:w-45 block dark:hidden"
          ...
          <div className="relative">
            ...
            <button
              ...
              py-3 px-6 rounded-full flex items-center h-10 gap-3 group -ml-1 mt-3 border border-black
      ...
      >
        ...
        <img className="mt-143 absolute w-33 container block dark:hidden" src="./assets/logoDQCompany.webp" alt=""/>
        <img className="mt-143 absolute w-33 container hidden dark:block" src="./assets/logoDQCompany.webp" alt=""/>
