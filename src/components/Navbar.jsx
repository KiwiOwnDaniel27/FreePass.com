  ...
  return (
    <div className="px-0">
      <div className="relative z-10 bg-[url('/assets/fondo.webp')] bg-contain bg-center flex mx-auto w-full flex-col p-6 h-53 shadow-lg 2xl:h-80">
        ...
        <button className="barra md:hidden" onClick={handleClick}>
          <RiMenuLine size={50} />
        </button>
        ...
        <div className="ml-auto">
          ...
          >
            <img
              className="-ml-20 2xl:-ml-23 xl:-ml-1 mt-0 2xl:-mt-33 xl:-mt-12 lg:-mt-12 md:-mt-12
          ...
          <button
            ...
            2xl:w-35 2xl:h-20 2xl:ml-16 xl:ml-29 lg:ml-23 md:ml-19 sm:ml-18"
          >
