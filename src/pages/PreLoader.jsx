...
const PreLoader = () => {
  ...
  return (
    loading && (
        <div className="w-full h-full fixed flex items-center justify-center z-50 bg-white">
            <video
             autoPlay
             loop
             muted
            ...
            <div role="status">
                ...
                <span className="flex ml-0 xl:-ml-6 mt-3 font-bold absolute">Bienvenido/as</span>
            </div>
        </div>
    )
  );
    ...
    loading && (
        ...
        xl:bg-bottom z-50">
            <div role="status">
                ...
                <span className="flex ml-0 xl:-ml-6 mt-3 font-bold">Bienvenido/as</span>
            </div>
        </div>
    )
  );
